...
pub struct KafkaConfig {
    ...
    #[envconfig(default = "false")]
    pub kafka_tls: bool,
    // SASL authentication. Set kafka_security_protocol to SASL_PLAINTEXT or SASL_SSL to enable.
    // All four fields are Option<String>; leaving them unset preserves existing plaintext/TLS behavior.
